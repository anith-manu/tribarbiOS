...
class ServiceListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tbvServices.backgroundColor = .white
    ...
    @IBAction func openIG(_ sender: Any) {
        UIApplication.shared.open(URL(string: "https://www.instagram.com/\(ig)")!) { (success) in
    ...
    @IBAction func openFB(_ sender: Any) {
        UIApplication.shared.open(URL(string: "https://www.facebook.com/\(fb)")!) { (success) in
